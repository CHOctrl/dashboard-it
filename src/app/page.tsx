  ...
  return (
    <PCProvider>
      <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans pb-24">
        {/* Header */}
        <header className="p-4 sm:p-6 border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-20">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent flex items-center gap-2">
        ...
        <main className="flex-grow p-4 sm:p-6 flex flex-col gap-6 max-w-7xl mx-auto w-full">
          ...
          <section className="flex-grow flex flex-col gap-2">
            <div className="flex justify-between items-end">
              <h2 className="text-xl font-semibold text-slate-700">Live Tracker</h2>
